...
/** Whether a user may open an ebook or video: admin, premium with the item included, or purchased. */
export async function canAccessProduct(user: CurrentUser | null, product: Pick<Product, "id" | "includedWithPremium">) {
